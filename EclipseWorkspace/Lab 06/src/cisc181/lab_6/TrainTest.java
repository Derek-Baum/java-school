...
public class TrainTest {
    ...
    public void test_Train() {
        ...
        assertEquals(cargoTrain.removeFromFront().equals("apples"),true);

        // add more TrainCars to your Train and  add Test cases to remove them
        
        cargoTrain.attachAtFront("one");
        assertEquals(cargoTrain.getHeadCargo().equals("one"),true);
        cargoTrain.attachAtFront("two");
        assertEquals(cargoTrain.getHeadCargo().equals("two"),true);
        cargoTrain.attachAtFront("three");
        assertEquals(cargoTrain.getHeadCargo().equals("three"),true);
        ...
        testTrain.attachAtFront("three");
        testTrain.attachAtFront("two");
        testTrain.attachAtFront("one");
        assertEquals(testTrain.removeFromEnd().equals("three"),true);
        assertEquals(testTrain.removeFromEnd().equals("two"),true);
        assertEquals(testTrain.removeFromEnd().equals("one"),true);
