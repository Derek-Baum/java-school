...
public class Lab5TestPartB {
    ...
    public void test_countM() {
        ...
        assertEquals(26, ArrayStaticMethods.countM("mmmmmmMMMMmmm YUMMMMMMMMMMMMM".toCharArray()));
    ...
    public void test_replace() {
        ...
        assertArrayEquals(new int[]{1,2,3,4,5}, ArrayStaticMethods.replace(new int[]{1,2,3,4,5}, 6, 5));
